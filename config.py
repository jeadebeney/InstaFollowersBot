hashtags_1 = ['dronephotography', 'travelgram', 'beach', 'lisbon', 'travelblogger', 'sunrise', 'landscape', 'discover', 'city', 'skyscrapper']

hashtags_2 = ['dronephoto', 'hkig', 'drone', 'sunset', 'sunrise', 'mountain', 'landscape', 'sea', 'ocean', 'blue', 'nature', 'sand']

hashtags_3 = ['travelers','traveling','travelholic','travelbug','travelgram','travelinggram','travelphotography','exploring','travelmore','lovetotravel']
...
hashtags_6 = ["friends", "repost", "nature", "girl", "fun", "style", "smile", "food", "instalike", "likeforlike", "family", "travel", "fitness", "igers", "tagsforlikes", 
"follow4follow", "nofilter"]

hashtags_7 = ["dog", "vsco", "l4l", "makeup", "f4f", "foodporn", "hair", "pretty", "swag", "cat", "model", "motivation", "girls", "baby", "party", "cool", "lol", "gym", 
"design", "instapic", "funny"]

hashtags_8 = ["night", "tflers", "yummy", "flowers", "lifestyle", "hot", "instafood", "wedding", "fit", "handmade", "black", "pink", "일상", "blue", 
"work", "workout", "blackandwhite", "drawing", "inspiration", "home"]
